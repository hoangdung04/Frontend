  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      if (res.data.code === "success") {
        ...
        if (user.roleId) {
          // Admin/Nhân viên → lưu vào bộ khóa admin để ProtectedRoute chấp nhận
          localStorage.setItem("admin_token", token);
          localStorage.setItem("admin_user", JSON.stringify(user));
          message.success("Đăng nhập quản trị thành công!");
          navigate("/admin/dashboard");
        } else {
          // Khách hàng → lưu vào bộ khóa client
          saveToken(token);
          saveUser(user);
    ...
    <div className="client-auth-page">
      ...
      <div className="client-auth-card">
        ...
        <div className="client-auth-logo">
          <img src={logoImg} className="client-auth-logo-img" alt="TourVN Logo" />
