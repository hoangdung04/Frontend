...
import {
  ...
  PhoneOutlined, FileTextOutlined, DollarOutlined, MailOutlined,
  EditOutlined
} from "@ant-design/icons";
import { getAdminOrderById, updateAdminOrderStatus, updateAdminOrder } from "../../../services/api";
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <Modal
        ...
        confirmLoading={updatingDetails}
        okText="Lưu lại"
        cancelText="Hủy"
      >
        <Form
          ...
          onFinish={async (values) => {
            ...
            try {
              const res = await updateAdminOrder(order.id, values);
