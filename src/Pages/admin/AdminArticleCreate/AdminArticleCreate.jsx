    ...
    <div>
      ...
      <Card bordered={false}>
        ...
        >
          ...
          <Form.Item label="Tóm tắt" name="description">
          ...
          <Form.Item label="Tour liên quan" name="tourIds">
            <Select
              ...
              filterOption={(input, option) => {
                const removeAccentsLocal = (str) => str.normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/đ/g, "d").replace(/Đ/g, "D").toLowerCase();
                return removeAccentsLocal(option?.label ?? "").includes(removeAccentsLocal(input));
              }}
            />
          </Form.Item>
