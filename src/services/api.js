...
export const sendAiChatMessage = (message, activeTourSlug, history) => api.post('/ai-chat', { message, activeTourSlug, history });
...
export const clientUpdateProfile = (formData) => api.patch('/auth/profile', formData, {
  headers: {
...
export const createAdminAccount = (formData) => api.post('/admin/accounts/create', formData, {
  headers: {
    'Content-Type': 'multipart/form-data'
  }
});
export const updateAdminAccount = (id, formData) => api.patch(`/admin/accounts/${id}`, formData, {
  headers: {
    'Content-Type': 'multipart/form-data'
  }
});
